...
export default function ProjectsPage() {
  ...
  const activeModule = "obras"; // Módulo ativo atual
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className="hidden lg:flex lg:flex-col lg:w-24 bg-white border-r border-gray-200">
                ...
                <Image
                  ...
                  className={`transition-all ${
                    activeModule === module.id
                      ...
                      : "grayscale opacity-50 group-hover:opacity-75"  // Cinza
                  }`}
                />
              </div>
              {/* Indicador ativo */}
        ...
        <div className="p-4 border-t border-gray-200">
          <Link
            href="/dashboard"
            className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl flex items-center justify-center hover:shadow-lg transition-all mx-auto"
          >
